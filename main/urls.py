...
path('save_message/<str:roomName>/<str:message>',views.SaveMessageAPI.as_view(),name="send_message"),
path('get_chat/<str:roomName>',views.GetChatAPI.as_view(),name="get_chat"),
